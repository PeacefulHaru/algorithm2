...
/**
 * After solve:
 * This question was actually very easy, but I have thought too hard.
 * I just saw a dude finishing this with three iterators.. jajaja
 */
...
const compare = (a, b) => {
  ...
  const [typeA, typeB] = [a * Math.pow(10, bLen) + b, b * Math.pow(10, aLen) + a]
